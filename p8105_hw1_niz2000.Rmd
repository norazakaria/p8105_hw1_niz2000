...
* A factor vector of length 8, and 3 different factor levels: "seed", "pit", and "peel"
...
Prob2_df = tibble(
  ...
  y = rnorm(500),
  vec_log = c(x + y > 1),
  vec_num = as.numeric(pull(Prob2_df, vec_log)),
  vec_fac = as.factor(pull(Prob2_df, vec_log))
)
head(Prob2_df)
```
...
The salmon dots on the scatterplots indicate false. The blue dots on the scatterplots indicate true.
